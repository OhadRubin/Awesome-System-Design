...
_PACKET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user', full_name='Packet.user', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='snapshot', full_name='Packet.snapshot', index=1,
...
_PACKET.fields_by_name['user'].message_type = _USER
_PACKET.fields_by_name['snapshot'].message_type = _SNAPSHOT
